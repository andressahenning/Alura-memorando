...
// Animações simultâneas com o método group
// Dentro do método query pode ser passado várias informações consultando elementos do DOM
export const formButtonTrigger = trigger('formButton', [
  transition('invalid => valid', [
    query('#botao-salvar', [
      group([
